// we can creat h1 or ul or li 
// also p or any HTML element 
//in javascript
//we have just to put the down code
//and put a div in html and put 
//that div in java script file 

    let mydiv = document.getElementById('thing');
    // the html div is "thing"
    ...
    //to creat li in ul with for loop
    ...
    //and last to call the function 
    // the function where did we put all
    //previos command in it
    myBookList();

    //to be sure the varibles name up is for this
